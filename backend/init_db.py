    ...
    try:
        ...
        if db.query(CrawlSource).count() == 0:
            ...
            sources = [
                ...
                # ===== P0 源：两区建设 & 监管部门（2026-08-13新增）=====
                {
                    "name": "北京市商务局-通知通告",
                    "source_type": "gov",
                    "crawl_type": "web",
                    "entry_url": "http://sw.beijing.gov.cn/zwxx/tzgg/",
                    "area_scope": ["北京市"],
                    "industry_scope": ["finance", "retail", "logistics", "culture"],
                    "priority": 9,
                    "selector_config": {
                        "list_selector": "div.newslist li, div.newslist_bg li",
                        "title_selector": "a",
                        "link_selector": "a@href",
                        "date_selector": "",
                        "date_regex": True,
                        "content_selector": ".view, .content, .article-content, .TRS_Editor",
                        "encoding": "utf-8",
                    },
                },
                {
                    ...
                    "source_type": "gov",
                    "crawl_type": "web",
                    "entry_url": "http://www.pbc.gov.cn/goutongjiaoliu/113456/113469/index.html",
                    "area_scope": ["全国"],
                    "industry_scope": ["finance"],
                    "priority": 9,
                    "selector_config": {
                        "list_selector": "div.mainw950 font.newslist_style",
                        "title_selector": "a",
                        "link_selector": "a@href",
                        "date_selector": "",
                        "date_regex": True,
                        "content_selector": ".zoom, #zoom, .content, .article, .TRS_Editor, .detail",
                        "encoding": "utf-8",
                        "note": "表格布局，日期在相邻td中，需正则提取",
                    },
                },
                {
                    "name": "国家金融监督管理总局-政策规章",
                    "source_type": "gov",
                    "crawl_type": "api",
                    "entry_url": "https://www.nfra.gov.cn/cn/view/pages/ItemList.html?itemPId=899&itemId=928",
                    "area_scope": ["全国"],
                    "industry_scope": ["finance"],
                    "priority": 9,
                    "is_active": True,
                    "selector_config": {
                        "api_url": "https://www.nfra.gov.cn/cbircweb/DocInfo/SelectDocByItemIdAndChild",
                        "api_params": {"itemId": "928", "pageSize": "18", "pageIndex": "1"},
                        "detail_api": "https://www.nfra.gov.cn/cbircweb/DocInfo/SelectByDocId",
                        "list_field": "data.rows",
                        "title_field": "docTitle",
                        "date_field": "publishDate",
                        "id_field": "docId",
                        "note": "AngularJS动态页面，通过API采集；需专门采集脚本",
                    },
                },
                {
                    "name": "北京两区公共信息服务平台-开放动态",
                    "source_type": "gov",
                    "crawl_type": "api",
                    "entry_url": "https://open.beijing.gov.cn/front/getListIndex2021.do?nid=18",
                    "area_scope": ["北京市"],
                    "industry_scope": ["finance", "logistics", "technology", "trade", "service"],
                    "priority": 9,
                    "is_active": True,
                    "selector_config": {
                        "api_url": "https://open.beijing.gov.cn/front/getListIndex2021.do",
                        "api_params": {"nid": "18"},
                        ...
                        "date_regex": True,
                        "date_format": "%Y/%m/%d",
                        "content_selector": ".DetailsContext, .context",
                        "base_url": "https://open.beijing.gov.cn",
                        "note": "两区建设开放动态，API返回HTML列表页，需专门采集脚本",
                    },
                },
